...
async function updateDriverInfoSheet(leaderboardData, telemetryData, lapData) {
  try {
    ...
    if (lastDriverInfoUpdate !== undefined) {
      console.log('last driver ahead split ', parseInt(lastDriverInfoUpdate[2].values[0][0]), ' is greater than this split? ', parseInt(driverAheadSplit) < parseInt(lastDriverInfoUpdate[2].values[0][0]));
